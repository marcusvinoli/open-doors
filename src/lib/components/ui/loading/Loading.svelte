<script lang="ts">
	import type { CircleTypes } from './Loading'
	export let size: CircleTypes['size'] = '60';
	export let unit: CircleTypes['unit'] = 'px';
	export let pause: CircleTypes['pause'] = false;
	export let ballTopLeft: CircleTypes['ballTopLeft'] = '#2AC6AC';
	export let ballTopRight: CircleTypes['ballTopRight'] = '#111725';
	export let ballBottomLeft: CircleTypes['ballBottomLeft'] = '#111725';
	export let ballBottomRight: CircleTypes['ballBottomRight'] = '#2AC6AC';
	export let duration: CircleTypes['duration'] = '1.5s';
</script>
